 ...
 * Licencia: GNU GPL V3
 *
 * La clase SecondaryAdmController gestiona las operaciones administrativas secundarias
 * dentro del sistema de concesionario. Permite al administrador realizar acciones
 * como gestionar clientes, empleados, vehículos, transacciones y reportes.
 */
    ...
    public boolean actualizarEmpleadoPorID(String id, Empleado nuevosDatos) {
        for (Empleado e : sistema.getEmpleados()) {
            if (e.getId().equals(id)) {
                ...
                e.setNombreDeUsuario(nuevosDatos.getNombreDeUsuario());
